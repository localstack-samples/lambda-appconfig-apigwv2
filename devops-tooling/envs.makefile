...
local-awscdk%: export TFSTACK_NAME=LambdaAppConfig-$(STACK_SUFFIX)
local-awscdk-vpc%: export TFSTACK_NAME=LambdaAppConfigVpc-$(STACK_SUFFIX)
...
sbx-awscdk%: export TFSTACK_NAME=LambdaAppConfig-$(STACK_SUFFIX)
sbx-awscdk-vpc%: export TFSTACK_NAME=LambdaAppConfigVpc-$(STACK_SUFFIX)
